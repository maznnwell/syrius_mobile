/*
This is a modified version of the Stepper from the Flutter SDK
 */
...
/// Defines the [SyriusStepper]'s main axis.
enum StepperType {
...
///
/// Used by [SyriusStepper.controlsBuilder].
@immutable
class ControlsDetails {
  ...
  /// Index that is active for the surrounding [SyriusStepper] widget. This may be
  ...
  /// just activated the transition to a new step, some [SyriusStepper.type] values will
...
/// A material step used in [SyriusStepper]. The step can have a title and subtitle,
...
@immutable
class Step {
  /// Creates a step for a [SyriusStepper].
  const Step({
    required this.title,
    this.subtitle,
...
///
/// {@tool dartpad}
/// An example the shows how to use the [SyriusStepper], and the [SyriusStepper] UI
/// appearance.
///
...
///  * [Step]
///  * <https://material.io/archive/guidelines/components/steppers.html>
class SyriusStepper extends StatefulWidget {
  ...
  @override
  State<SyriusStepper> createState() => _SyriusStepperState();
}

class _SyriusStepperState extends State<SyriusStepper> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(SyriusStepper oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    assert(() {
      if (context.findAncestorWidgetOfExactType<SyriusStepper>() != null) {
        throw FlutterError(
